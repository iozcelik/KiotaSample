...
using System;
namespace AtlassianClient.Rest.Api.Three.User.Permission.Search {
    /// <summary>
    ...
    public class SearchRequestBuilder : BaseRequestBuilder {
        ...
        public SearchRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/rest/api/3/user/permission/search{?query*,username*,accountId*,permissions*,issueKey*,projectKey*,startAt*,maxResults*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new SearchRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SearchRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/rest/api/3/user/permission/search{?query*,username*,accountId*,permissions*,issueKey*,projectKey*,startAt*,maxResults*}", rawUrl) {
        }
        /// <summary>
