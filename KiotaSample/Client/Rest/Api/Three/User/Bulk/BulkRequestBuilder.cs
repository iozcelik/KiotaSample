...
using AtlassianClient.Rest.Api.Three.User.Bulk.Migration;
...
using System;
namespace AtlassianClient.Rest.Api.Three.User.Bulk {
    /// <summary>
    ...
    public class BulkRequestBuilder : BaseRequestBuilder {
        ...
        public BulkRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/rest/api/3/user/bulk{?startAt*,maxResults*,username*,key*,accountId*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new BulkRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public BulkRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/rest/api/3/user/bulk{?startAt*,maxResults*,username*,key*,accountId*}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<PageBeanUser?> GetAsync(Action<BulkRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<PageBeanUser> GetAsync(Action<BulkRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
