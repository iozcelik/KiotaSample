...
using System;
namespace AtlassianClient.Rest.Api.Three.Screens.Item.Tabs.Item.Fields.Item.Move {
    /// <summary>
...
#nullable enable
        public async Task PostAsync(MoveFieldBean body, Action<MoveRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task PostAsync(MoveFieldBean body, Action<MoveRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(MoveFieldBean body, Action<MoveRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(MoveFieldBean body, Action<MoveRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
