// <auto-generated/>
using AtlassianClient.Rest.Api.Three.Screens.Item.Tabs.Item.Fields.Item.Move;
...
using System;
namespace AtlassianClient.Rest.Api.Three.Screens.Item.Tabs.Item.Fields.Item {
    /// <summary>
    ...
    public class WithIdItemRequestBuilder : BaseRequestBuilder {
        ...
        public WithIdItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/rest/api/3/screens/{screenId}/tabs/{tabId}/fields/{id}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new WithIdItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithIdItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/rest/api/3/screens/{screenId}/tabs/{tabId}/fields/{id}", rawUrl) {
        }
        /// <summary>
