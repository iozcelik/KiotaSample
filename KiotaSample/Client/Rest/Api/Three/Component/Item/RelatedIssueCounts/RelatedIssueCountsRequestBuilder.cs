...
using System;
namespace AtlassianClient.Rest.Api.Three.Component.Item.RelatedIssueCounts {
    /// <summary>
...
#nullable enable
        public async Task<ComponentIssuesCount?> GetAsync(Action<RelatedIssueCountsRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<ComponentIssuesCount> GetAsync(Action<RelatedIssueCountsRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
