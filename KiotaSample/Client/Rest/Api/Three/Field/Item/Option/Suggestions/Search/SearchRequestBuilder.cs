...
using System;
namespace AtlassianClient.Rest.Api.Three.Field.Item.Option.Suggestions.Search {
    /// <summary>
    /// Builds and executes requests for operations under \rest\api\3\field\{fieldKey}\option\suggestions\search
    /// </summary>
    public class SearchRequestBuilder : BaseRequestBuilder {
        ...
        public SearchRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/rest/api/3/field/{fieldKey}/option/suggestions/search{?startAt*,maxResults*,projectId*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new SearchRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SearchRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/rest/api/3/field/{fieldKey}/option/suggestions/search{?startAt*,maxResults*,projectId*}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<PageBeanIssueFieldOption?> GetAsync(Action<SearchRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<PageBeanIssueFieldOption> GetAsync(Action<SearchRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
