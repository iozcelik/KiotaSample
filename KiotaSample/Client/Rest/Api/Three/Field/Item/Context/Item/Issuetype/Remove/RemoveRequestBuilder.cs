...
using System;
namespace AtlassianClient.Rest.Api.Three.Field.Item.Context.Item.Issuetype.Remove {
    /// <summary>
    /// Builds and executes requests for operations under \rest\api\3\field\{fieldId}\context\{contextId}\issuetype\remove
    /// </summary>
    public class RemoveRequestBuilder : BaseRequestBuilder {
        ...
        public RemoveRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/rest/api/3/field/{fieldId}/context/{contextId}/issuetype/remove", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new RemoveRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RemoveRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/rest/api/3/field/{fieldId}/context/{contextId}/issuetype/remove", rawUrl) {
        }
        /// <summary>
