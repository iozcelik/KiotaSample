...
using AtlassianClient.Rest.Api.Three.Workflows.Create.Validation;
...
using System;
namespace AtlassianClient.Rest.Api.Three.Workflows.Create {
    /// <summary>
...
#nullable enable
        public async Task<WorkflowCreateResponse?> PostAsync(WorkflowCreateRequest body, Action<CreateRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<WorkflowCreateResponse> PostAsync(WorkflowCreateRequest body, Action<CreateRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(WorkflowCreateRequest body, Action<CreateRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(WorkflowCreateRequest body, Action<CreateRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
