...
using System;
namespace AtlassianClient.Rest.Api.Three.Project.Item.Avatar2 {
    /// <summary>
    /// Builds and executes requests for operations under \rest\api\3\project\{projectIdOrKey}\avatar2
    /// </summary>
    public class Avatar2RequestBuilder : BaseRequestBuilder {
        ...
        public Avatar2RequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/rest/api/3/project/{projectIdOrKey}/avatar2{?x*,y*,size*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new Avatar2RequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public Avatar2RequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/rest/api/3/project/{projectIdOrKey}/avatar2{?x*,y*,size*}", rawUrl) {
        }
        /// <summary>
