...
using AtlassianClient.Rest.Api.Three.Issue.Item.Worklog.Item.Properties.Item;
...
using System;
namespace AtlassianClient.Rest.Api.Three.Issue.Item.Worklog.Item.Properties {
    /// <summary>
    ...
    public class PropertiesRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the AtlassianClient.rest.api.Three.issue.item.worklog.item.properties.item collection</summary>
        ...
        public PropertiesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/rest/api/3/issue/{issueIdOrKey}/worklog/{id}/properties", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new PropertiesRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public PropertiesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/rest/api/3/issue/{issueIdOrKey}/worklog/{id}/properties", rawUrl) {
        }
        /// <summary>
